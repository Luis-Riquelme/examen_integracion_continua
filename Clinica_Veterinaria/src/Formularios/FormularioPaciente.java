...
public class FormularioPaciente extends javax.swing.JInternalFrame 
{
    ...
    public void ModificarPaciente(String id) 
    {
        ...
        {
            Paciente cal = new Paciente();
            modelo=cal.GetPaciente(id);
            if (modelo.getRowCount() > 0) 
            {
				txt_nombre.setText(modelo.getColumnName(0));
				txt_color.setText(modelo.getColumnName(1));
				txt_fechanac.setDateFormatString(modelo.getColumnName(2));
				txt_especie.setText(modelo.getColumnName(3));
				txt_raza.setText(modelo.getColumnName(4));
				//cbo_sexo.setDropTarget(modelo.getColumnName(5));
				txt_rut.setText(modelo.getColumnName(6));
            } 
            else 
            {
                JOptionPane.showMessageDialog(null, "No Existen Paciente", "Búsqueda Inválida", JOptionPane.PLAIN_MESSAGE);
            }
    ...
    public void EliminarPaciente(String id) 
    {
        try 
        {
            ...
            Paciente cal = new Paciente();
            if (cal.EliPaciente(id)) 
            {
            	JOptionPane.showMessageDialog(null, "Se ha eliminado el paciente", "Proceso Éxitoso", JOptionPane.PLAIN_MESSAGE);
            } 
            else 
            {
                JOptionPane.showMessageDialog(null, "No Existen paciente", "Falló Eliminación", JOptionPane.PLAIN_MESSAGE);
            }        	
            z = 1;
            cargar_datos("");
        } catch (Exception ex) 
    ...
    private void btn_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_guardarActionPerformed
        ...
        {
            mensaje = "Los datos del paciente se han insertado de manera satisfactoria";
            z = 1;
            ...
            { 
                ...
                Paciente cal = new Paciente();
                if (cal.AgrPaciente(nombre, color, fecha_nacimiento, especie, raza, sexo, rut_cliente) > 0) 
                {
        ...
        } else if (accion.equals("Modificar")) 
        {
            ...
            {
            	Paciente cal = new Paciente();
                if (cal.ModPaciente(nombre, color, fecha_nacimiento, especie, raza, sexo, rut_cliente, id_actualizar) > 0)
                {
                    JOptionPane.showMessageDialog(null, mensaje, "Proceso Exitoso de Actualización paciente de rut: "+id_actualizar, JOptionPane.PLAIN_MESSAGE);
                } else {
                	JOptionPane.showMessageDialog(null, "Error al Actualizar el paciente", "Proceso Erróneo", JOptionPane.PLAIN_MESSAGE);
                }
            } 
            catch (Exception ex) {
                JOptionPane.showMessageDialog(null, "Error al Actualizar el paciente", "Proceso Erróneo", JOptionPane.PLAIN_MESSAGE);
