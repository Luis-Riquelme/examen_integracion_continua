...
public class FormularioCliente extends javax.swing.JInternalFrame 
{
    ...
    public void ModificarCliente(String id) {
        ...
        {
            Cliente cal = new Cliente();
            modelo=cal.GetCliente(id);
            if (modelo.getRowCount() > 0) 
            {
				txt_rut.setText(modelo.getColumnName(0));
				txt_nombre.setText(modelo.getColumnName(1));
				txt_direccion.setText(modelo.getColumnName(2));
				txt_telefono.setText(modelo.getColumnName(3));
				txt_mail.setText(modelo.getColumnName(4));
            } 
            else 
            {
                JOptionPane.showMessageDialog(null, "No Existen clienten", "Búsqueda Inválida", JOptionPane.PLAIN_MESSAGE);
    ...
    public void EliminarCliente(String id) 
    {
        try 
        {
            ...
            Cliente cal = new Cliente();
            if (cal.EliCliente(id)) 
            {
            	JOptionPane.showMessageDialog(null, "Se ha eliminado el cliente", "Proceso Éxitoso", JOptionPane.PLAIN_MESSAGE);
            } 
            else 
            {
                JOptionPane.showMessageDialog(null, "No Existen clienten", "Falló Eliminación", JOptionPane.PLAIN_MESSAGE);
            }        	
            z = 1;
            cargar_datos("");
        } catch (Exception ex) 
    ...
    private void btn_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_guardarActionPerformed
        ...
        if (accion.equals("Insertar")) {
            ...
            { 
                ...
                Cliente cal = new Cliente();
                if (cal.AgrCliente(rut_cliente, nombre, direccion, telefono, mail) > 0) 
                {
                    JOptionPane.showMessageDialog(null, mensaje, "Proceso Éxitoso", JOptionPane.PLAIN_MESSAGE);
                } else {
                	JOptionPane.showMessageDialog(null, "Error al Insertar el cliente", "Proceso Erróneo", JOptionPane.PLAIN_MESSAGE);
                }
            ...
            try 
            {
                ...
                if (cal.ModCliente(rut_cliente, nombre, direccion, telefono, mail) > 0)
                {
                	...
                	JOptionPane.showMessageDialog(null, "Error al Actualizar el cliente", "Proceso Erróneo", JOptionPane.PLAIN_MESSAGE);
                }
    ...
    private void btn_guardar2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_guardar2ActionPerformed
        ...
        if (accion.equals("Insertar")) {
            try 
            {
                ...
                if (pas.AgrPaciente(nombre, color, fecha_nacimiento, especie, raza, sexo, rut_cliente) > 0) 
                {
                    JOptionPane.showMessageDialog(null, mensaje, "Proceso Éxitoso de inserción Paciente", JOptionPane.PLAIN_MESSAGE);
                } else {
                	JOptionPane.showMessageDialog(null, "Error al Insertar el paciente", "Proceso Erróneo", JOptionPane.PLAIN_MESSAGE);
                }
            } 
            catch (Exception ex) 
            {
